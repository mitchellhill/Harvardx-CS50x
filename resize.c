...
int main(int argc, char* argv[])
{
    ...
    if (n <= 0 || n > 100)
    {
        printf("Please enter a positive number between 1 and 100!");
        return 5;
    }
    ...
    newBi.biSizeImage = bi.biSizeImage * n;
    ...
    int bytesPerRow = 3 * bi.biWidth + padding;
    ...
    {        
        ...
        for (int h = 0; h < n; h++)
        {
            fseek(inptr, (54 + (i * bytesPerRow)), SEEK_SET);   
